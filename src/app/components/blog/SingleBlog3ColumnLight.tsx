    ...
    return (
        <>
            <div className="home-blog-style-one">
                <div className="thumb">
                    <Link to={`/blog-single-with-sidebar-light/${toBlogUrlFriendly(title2 || '')}`}>
                    ...
                    <div className="info">
                        ...
                        <h2 className="post-title">
                            <Link to={`/blog-single-with-sidebar-light/${toBlogUrlFriendly(title2 || '')}`}>{title2}</Link>
                        </h2>
                        <Link to={`/blog-single-with-sidebar-light/${toBlogUrlFriendly(title2 || '')}`} className="button-regular">
                            Continue Reading
