...
const BlogSingleWithSidebarContentLight = ({ blogInfo, totalBlogs, sectionClass }: BlogSingleProps) => {
    ...
    const previousIndex = currentIndex === 0 ? (totalBlogs || 1) - 1 : currentIndex - 1;
    const nextIndex = currentIndex === (totalBlogs || 1) - 1 ? 0 : currentIndex + 1;
                            ...
                            <div className="blog-content col-xl-8 col-lg-7 col-md-12 pr-35 pr-md-15 pl-md-15 pr-xs-15 pl-xs-15">
                                ...
                                <div className="post-pagi-area">
                                    <div className="post-previous">
                                        <Link to={`/blog-single-with-sidebar-light/${toBlogUrlFriendly(previousBlog?.title2 || '')}`}>
                                    ...
                                    <div className="post-next">
                                        <Link to={`/blog-single-with-sidebar-light/${toBlogUrlFriendly(nextBlog?.title2 || '')}`}>
