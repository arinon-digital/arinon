...
import arrowThemeIcon from '../../../../public/assets/img/icon/arrow-theme.png';
...
const AboutV1 = ({ lightMode }: DataType) => {
    ...
    return (
        <>
            <div className="bg-cover about-style-one-area default-padding"
                style={{ backgroundImage: lightMode ? 'none' : 'url(../../../../public/assets/img/shape/13.png)' }}>
