import illustration6 from '../../../../public/assets/img/illustration/6.png';
import thumb10 from '../../../../public/assets/img/thumb/10.jpg';
import icon12 from '../../../../public/assets/img/icon/12.png';
import icon13 from '../../../../public/assets/img/icon/13.png';
        ...
        <>
            <div className={`about-style-five-area default-padding overflow-hidden ${sectionClass ? sectionClass : ""}`}>
                <div className="shape-right-bottom upDownScrol">
                    <img src={illustration6.src} alt="Image Not Found" />
                </div>
                            ...
                            <div className="col-xl-8 col-lg-7 pl-50 pl-md-15 pl-xs-15">
                                <div className="banner-style-five-info">
                                    <div className="d-grid">
                                        <div className="thumb">
                                            <img src={thumb10.src} alt="Image Not Found" />
                                        </div>
                                        <ul className="list-style-four">
                                            <li>
                                                <div className="icon">
                                                    <img src={icon12.src} alt="Image Not Found" />
                                                </div>
                                                <div className="info">
                                            ...
                                            <li>
                                                <div className="icon">
                                                    <img src={icon13.src} alt="Image Not Found" />
                                                </div>
                                                <div className="info">
                                                    <h4>3D Rendering</h4>
                                                    <p>
