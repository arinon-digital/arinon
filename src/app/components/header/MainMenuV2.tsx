                ...
                <li>
                    ...
                    <ul className="sub-menu">
                        ...
                        <li><Link to="/blog-3-column" onClick={closeInfoBar}>Blog Grid Three column</Link></li>
                                                    <li><Link to="/blog-single/limited-creativity-is-the-killer" onClick={closeInfoBar}>Blog Single</Link></li>
                            <li><Link to="/blog-single-with-sidebar/limited-creativity-is-the-killer" onClick={closeInfoBar}>Blog Single With Sidebar</Link></li>
                    </ul>
                </li>
