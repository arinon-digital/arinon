...
const ProjectDetailsLightContent = ({ projectInfo, sectionClass, totalProjects }: ProjectDetailsProps) => {
    const { title, tag, client } = projectInfo || {};
                        ...
                        <div className="col-lg-12">
                            <div className="project-paginvation-items">
                                <div className="project-previous">
                                    <Link to={`/project-details-light/${toUrlFriendly(previousProject?.client || '')}`}>
                                ...
                                <div className="project-next">
                                    <Link to={`/project-details-light/${toUrlFriendly(nextProject?.client || '')}`}>
