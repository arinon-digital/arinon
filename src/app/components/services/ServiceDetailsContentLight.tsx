                ...
                <div className="container">
                    <div className="services-details-items">
                        ...
                        <div className="row">
                            ...
                            <div className="pl-60 pl-md-15 pl-xs-15 col-lg-5">
                                <p>
                                    ...
                                    <div className="accordion" id="faqAccordion">
                                        ...
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" id="headingTwo">
                                                <button className="collapsed accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        ...
                                        <div className="accordion-item">
                                            <h2 className="accordion-header" id="headingThree">
                                                <button className="collapsed accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                        ...
                        <div className="mt-100 mt-xs-30 services-more">
