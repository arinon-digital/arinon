...
const SinglePortfolioV3Light = ({ portfolio }: { portfolio: DataType }) => {
    const { client, thumbLight, date, titleFirst, titleLast } = portfolio
            ...
            <div className="portfolio-style-three-item">
                <div className="row align-center">
                    ...
                    <div className="col-lg-5">
                        ...
                        <h2><Link to={`/project-details-light/${toUrlFriendly(client || '')}`}>{titleFirst} <strong>{titleLast}</strong></Link></h2>
                        <Link className="btn-animation mt-10" to={`/project-details-light/${toUrlFriendly(client || '')}`}>
